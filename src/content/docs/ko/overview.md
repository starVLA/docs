...
- **기술 보고서**: [*StarVLA: A Lego-like Codebase for Vision-Language-Action Model Developing*](https://arxiv.org/abs/2604.05014) (arXiv:2604.05014).
- **Overleaf 실시간 리포트**: 최신 벤치마크 데이터와 분석이 포함된, 지속적으로 업데이트되는 실험 보고서 PDF — https://www.overleaf.com/read/qqtwrnprctkf#d5bdce
