...
|-----------|-------------------|
| Understand StarVLA's design | [Lego-like Design](/docs/design/lego-like/) |
| Run evaluation with existing checkpoints | Check [Model Zoo](/docs/model-zoo/) for checkpoints, then follow a benchmark guide ([LIBERO](/docs/benchmarks/libero/), [SimplerEnv](/docs/benchmarks/simplerenv/)) |
| Train with your own data | [Use Your Own LeRobot Dataset](/docs/training/lerobot-dataset/) |
| Co-train with VLM data | [Co-Training with VLM Data](/docs/training/cotrain-vlm/) |
