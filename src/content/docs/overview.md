...
- Set up your environment and verify installation in [Quick Start](/docs/getting-started/quick-start/).
- Explore design principles in [Lego-like Design](/docs/design/lego-like/).
- Browse checkpoints in [Model Zoo](/docs/model-zoo/).
...
- **2025/12/25**: RoboCasa evaluation support released, achieving SOTA without pretraining. See the [RoboCasa documentation](/docs/benchmarks/robocasa/).
...
- **2025/12/09**: Open-source training for VLM, VLA, and VLA+VLM co-training. See the [VLM co-training documentation](/docs/training/cotrain-vlm/).
- **2025/11/12**: Florence-2 support added for resource-constrained VLM training (single A100). See [Lego-like Design](/docs/design/lego-like/) for workflow notes.
