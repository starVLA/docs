...
| 你的目标 | 推荐阅读 |
|---------|---------|
| 了解 StarVLA 的设计理念 | [乐高式设计](/docs/zh-cn/design/lego-like/) |
| 用已有 checkpoint 跑评测 | 先看 [模型库](/docs/zh-cn/model-zoo/) 下载 checkpoint，再看对应 Benchmark（如 [LIBERO](/docs/zh-cn/benchmarks/libero/)、[SimplerEnv](/docs/zh-cn/benchmarks/simplerenv/)） |
| 用自己的数据训练模型 | [使用自己的 LeRobot 数据集](/docs/zh-cn/training/lerobot-dataset/) |
| 在 VLM 数据上联合训练 | [与 VLM 数据联合训练](/docs/zh-cn/training/cotrain-vlm/) |
| 查看常见问题 | [FAQ](/docs/zh-cn/faq/) |
