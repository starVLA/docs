...
| 任务名称 | StarVLA-OFT Easy | StarVLA-OFT Hard | π0 Easy | π0 Hard | π0.5 Easy | π0.5 Hard | X-VLA Easy | X-VLA Hard | Motus Easy | Motus Hard | lingbot-vla w/o depth Easy | lingbot-vla w/o depth Hard | lingbot-vla w/ depth Easy | lingbot-vla w/ depth Hard |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
...
请先参考 [官方 RoboTwin 安装指南](https://robotwin-platform.github.io/doc/usage/robotwin-install.html) 安装基础 `robotwin` 环境。
...
所有模式包括 `demo_clean` 和 `demo_randomized`。
